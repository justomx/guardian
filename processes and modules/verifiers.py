...
env_path = Path(r'G:\Meu Drive\API KEYS\Slack Bot - Files\.env.txt')
...
class ProcessRegistrant:
    ...
    def __init__(self):
        ...
        # Adicionando ambos os handlers ao logger
    ...
    def call_critical(self):
        ...
        send_message('CRITICAL ERROR - <!channel> the automatization management has stopped.', 'bot_channel')
