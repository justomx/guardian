...
"""
    Serve estritamente para fins de:
        - Definir reports utilizados em cada tipo de automatização
"""   
...
class MReport37():
    ...
    @property
    def link(self):
        result = 'https://infinite.justo.mx/question/1587-fraud-prevention-tool-br-all-orders?from='+self.metabase_date_format.current_month_first_day+'&to='+self.metabase_date_format.today
        return result
    limit_time=60
...
class MReport62():
    ...
    @property
    def link(self):
        result = 'https://infinite.justo.mx/question/6688'
        return result
    limit_time=120
...
class GReport08(): 
    ...
    @property
    def link(self):
        result = 'https://docs.google.com/spreadsheets/d/1-7j7BrA78hIWDkjLEorsJyatNa6RXNxAeOgHrEe1gmQ/edit#gid=990212466'
        return result
    limit_time=40   
