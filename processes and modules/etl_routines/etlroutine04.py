...
mi = MachineInfo()
pd.options.display.float_format = '{:,.2f}'.format #formato decimal padrão para número
...
df0.to_excel(r'G:\Drives compartilhados\Data & Performance\Relatórios\18 - EXPERIENCIA DO CLIENTE\Bases\ENVIO WHATSAPP\envio_bot_maker_'+today_date+'.xlsx', index=False)
