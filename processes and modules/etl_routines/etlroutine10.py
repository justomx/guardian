...
file = str(r'G:'+machine_info.pathlang0+r'\Data & Performance\Relatórios Justo Insights\AMBEV\Detalle de transacci 2023'+str((datetime.today() - timedelta(days=1)).strftime('%m'))+r'.csv')
...
try:
    ...
    e10="Ambev sales file didn't uploaded."
    print(e10)
